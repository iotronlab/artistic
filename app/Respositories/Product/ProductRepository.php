...
use App\Scoping\Scopes\ProductSortScope;
...
class ProductRepository extends Repository
{
    ...
    public function getAll()
    {
        ...
        $results = Product::with('variants', 'categories', 'flat', 'vendor', 'images', 'stock_addresses', 'ordered_stocks')
