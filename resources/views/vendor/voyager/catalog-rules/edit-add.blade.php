 ...
 <script src="{{asset('js/app.js')}}" defer></script>
                            ...
                            <div slot="body">
                                ...
                                <div class="control-group" :class="[errors.has('customer_groups[]') ? 'has-error' : '']">
                                    ...
                                    <select class="control" id="customer_groups" name="customer_groups[]" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.catalog-rules.customer-groups') }}&quot;" multiple="multiple">
                                        ...
                                        @foreach(app('\App\Repositories\Customer\CustomerGroupRepository')->all() as $customerGroup)
                                ...
                                <div class="control-group date">
                                    <label for="starts_from">Catalog Rule Start Date:</label>
                                    <date>
                                ...
                                <div class="control-group date">
                                    <label for="ends_till">Catalog Rule End date:</label>
                                    <date>
    ...
    <script>
        ...
        Vue.component('catalog-rule-condition-item', {
            ...
            data: function() {
                return {
                    condition_attributes: @json(app('\App\Repositories\CatalogRule\CatalogRuleRepository')->getConditionAttributes()),
